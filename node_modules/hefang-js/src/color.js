...
function parseColor(colorString) {
    ...
    else if (colorString in exports.colorMap) {
        return parseColor(exports.colorMap[colorString]);
    }
    return color;
}
exports.parseColor = parseColor;
function p(rgb) {
    return string_1.padStart(rgb.toString(16), 2, 0);
}
function rgba2string(red, green, blue, alpha) {
...
function hsl2rgb(h, s, l) {
    ...
    if (s === 0) {
        ...
        var p_1 = 2 * l - q;
        rgb.red = hue2rgb(p_1, q, h + 1 / 3);
        rgb.green = hue2rgb(p_1, q, h);
        rgb.blue = hue2rgb(p_1, q, h - 1 / 3);
    }
    ["red", "green", "blue"].forEach(function (c) { return rgb[c] = Math.round(rgb[c] * 255); });
    return rgb;
}
exports.hsl2rgb = hsl2rgb;
function hslColor2Rgb(hsl) {
    return hsl2rgb(hsl.hue, hsl.saturation, hsl.lightness);
}
exports.hslColor2Rgb = hslColor2Rgb;
function rgbColor2Hsl(color) {
    return rgb2hsl(color.red, color.green, color.blue);
}
exports.rgbColor2Hsl = rgbColor2Hsl;
/**
 *
